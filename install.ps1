...
$oshPath = Join-Path $env:PROGRAMFILES "Open-Shell" startmenu.exe
...
# Set-ItemProperty -Path $shellregPath\StartMenu\Settings -Name 'MouseClickCommand' -Value ''
# Set-ItemProperty -Path $shellregPath\StartMenu\Settings -Name 'ShiftClickCommand' -Value ''
# Set-ItemProperty -Path $shellregPath\StartMenu\Settings -Name 'WinKeyCommand' -Value ''
