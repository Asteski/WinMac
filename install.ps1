...
# Set-ItemProperty for [HKEY_CURRENT_USER\Software\OpenShell\ClassicExplorer]
...
Set-ItemProperty -Path "HKCU:\Software\OpenShell\ClassicExplorer" -Name "CSettingsDlg" -Value ([byte[]](0x38,0x02,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x02,0x08,0x00,0x00,0x00,0x00,0xb1,0x70,0x00,0x00,0x00,0x00))

# Set-ItemProperty for [HKEY_CURRENT_USER\Software\OpenShell\ClassicExplorer\Settings]
Set-ItemProperty -Path "HKCU:\Software\OpenShell\ClassicExplorer\Settings" -Name "Version" -Value 1087
...
Set-ItemProperty -Path "HKCU:\Software\OpenShell\ClassicExplorer\Settings" -Name "NoFadeButtons" -Value 0
...
Set-ItemProperty -Path "HKCU:\Software\OpenShell\ClassicExplorer\Settings" -Name "ToolbarItems" -Value ([byte[]](0x00,0x00))

# Set-ItemProperty for [HKEY_CURRENT_USER\Software\OpenShell\OpenShell]
Set-ItemProperty -Path "HKCU:\Software\OpenShell\OpenShell" -Name "LastUpdateTime" -Value 375982120

# Set-ItemProperty for [HKEY_CURRENT_USER\Software\OpenShell\OpenShell\Settings]
Set-ItemProperty -Path "HKCU:\Software\OpenShell\OpenShell\Settings" -Name "Nightly" -Value 1

# Set-ItemProperty for [HKEY_CURRENT_USER\Software\OpenShell\StartMenu]
Set-ItemProperty -Path "HKCU:\Software\OpenShell\StartMenu" -Name "ShowedStyle2" -Value 1
...
# Set-ItemProperty for [HKEY_CURRENT_USER\Software\OpenShell\StartMenu\Settings]
Set-ItemProperty -Path "HKCU:\Software\OpenShell\StartMenu\Settings" -Name "Version" -Value 1087
...
# Set-ItemProperty for [HKEY_CURRENT_USER\Software\OpenShell\StartMenu\Settings]
Set-ItemProperty -Path "HKCU:\Software\OpenShell\StartMenu\Settings" -Name "CascadingMenu" -Value 1
Set-ItemProperty -Path "HKCU:\Software\OpenShell\StartMenu\Settings" -Name "RemoteShutdown" -Value 0
Set-ItemProperty -Path "HKCU:\Software\OpenShell\StartMenu\Settings" -Name "HybridShutdown" -Value 0
Set-ItemProperty -Path "HKCU:\Software\OpenShell\StartMenu\Settings" -Name "StartScreenShortcut" -Value 0
Set-ItemProperty -Path "HKCU:\Software\OpenShell\StartMenu\Settings" -Name "NumericSort" -Value 0
Set-ItemProperty -Path "HKCU:\Software\OpenShell\StartMenu\Settings" -Name "MenuShadow" -Value 0
Set-ItemProperty -Path "HKCU:\Software\OpenShell\StartMenu\Settings" -Name "EnableGlass" -Value 0
Set-ItemProperty -Path "HKCU:\Software\OpenShell\StartMenu\Settings" -Name "MiddleClickCommand" -Value ""
Set-ItemProperty -Path "HKCU:\Software\OpenShell\StartMenu\Settings" -Name "ShiftClickCommand" -Value "C:\Users\Administrator\OneDrive\Documents\Git\WinMac\bin\power.exe"
Set-ItemProperty -Path "HKCU:\Software\OpenShell\StartMenu\Settings" -Name "ExpandFolderLinks" -Value 0
Set-ItemProperty -Path "HKCU:\Software\OpenShell\StartMenu\Settings" -Name "OpenTruePath" -Value 0
Set-ItemProperty -Path "HKCU:\Software\OpenShell\StartMenu\Settings" -Name "EnableAccessibility" -Value 0
Set-ItemProperty -Path "HKCU:\Software\OpenShell\StartMenu\Settings" -Name "ShowNextToTaskbar" -Value 0
Set-ItemProperty -Path "HKCU:\Software\OpenShell\StartMenu\Settings" -Name "PreCacheIcons" -Value 0
Set-ItemProperty -Path "HKCU:\Software\OpenShell\StartMenu\Settings" -Name "DelayIcons" -Value 0
Set-ItemProperty -Path "HKCU:\Software\OpenShell\StartMenu\Settings" -Name "BoldSettings" -Value 0
Set-ItemProperty -Path "HKCU:\Software\OpenShell\StartMenu\Settings" -Name "EnableAccelerators" -Value 0
