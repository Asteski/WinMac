...
Set-ItemProperty -Path $shellRegPath\ClassicExplorer -Name 'Version' -Value 0x040400bf
Set-ItemProperty -Path $shellRegPath\ClassicExplorer -Name 'TreeStyle' -Value 'Vista'
Set-ItemProperty -Path $shellRegPath\ClassicExplorer -Name 'HScrollbar' -Value 'Default'
Set-ItemProperty -Path $shellRegPath\ClassicExplorer -Name 'NoFadeButtons' -Value 0
Set-ItemProperty -Path $shellRegPath\ClassicExplorer -Name 'HideSearch' -Value 0
Set-ItemProperty -Path $shellRegPath\ClassicExplorer -Name 'UseBigButtons' -Value 0
Set-ItemProperty -Path $shellRegPath\ClassicExplorer -Name 'ShowStatusBar' -Value 0
Set-ItemProperty -Path $shellRegPath\ClassicExplorer -Name 'AltEnter' -Value 0
Set-ItemProperty -Path $shellRegPath\ClassicExplorer -Name 'DisableBreadcrumbs' -Value 0
Set-ItemProperty -Path $shellRegPath\ClassicExplorer -Name 'ToolbarItems' -Value ([byte[]](0x00,0x00))
Set-ItemProperty -Path $shellRegPath\OpenShell -Name 'LastUpdateTime' -Value 0x161cde38
Set-ItemProperty -Path $shellRegPath\OpenShell -Name 'Nightly' -Value 1
...
Set-ItemProperty -Path $shellRegPath\StartMenu -Name 'Version' -Value 0x040400bf
Set-ItemProperty -Path $shellRegPath\StartMenu -Name 'MouseClickCommand' -Value 'C:\Users\astes\Documents\WinMac\bin\start.exe'
Set-ItemProperty -Path $shellRegPath\StartMenu -Name 'ShiftClickCommand' -Value 'C:\Users\astes\Documents\WinMac\bin\power.exe'
Set-ItemProperty -Path $shellRegPath\StartMenu -Name 'WinKeyCommand' -Value 'C:\Users\astes\Documents\WinMac\bin\start.exe'
Set-ItemProperty -Path $shellRegPath\StartMenu -Name 'ShiftWin' -Value 'Nothing'
Set-ItemProperty -Path $shellRegPath\StartMenu -Name 'SearchBox' -Value 'Hide'
Set-ItemProperty -Path $shellRegPath\StartMenu -Name 'SkinW7' -Value 'Immersive'
Set-ItemProperty -Path $shellRegPath\StartMenu -Name 'SkinVariationW7' -Value ''
Set-ItemProperty -Path $shellRegPath\StartMenu -Name 'SkinOptionsW7' -Value ([byte[]]())
