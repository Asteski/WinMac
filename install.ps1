...
Set-ItemProperty -Path $shellRegPath\ClassicExplorer\Settings -Name 'Version' -Value 0x040400bf
Set-ItemProperty -Path $shellRegPath\ClassicExplorer\Settings -Name 'TreeStyle' -Value 'Vista'
Set-ItemProperty -Path $shellRegPath\ClassicExplorer\Settings -Name 'HScrollbar' -Value 'Default'
Set-ItemProperty -Path $shellRegPath\ClassicExplorer\Settings -Name 'NoFadeButtons' -Value 0
Set-ItemProperty -Path $shellRegPath\ClassicExplorer\Settings -Name 'HideSearch' -Value 0
Set-ItemProperty -Path $shellRegPath\ClassicExplorer\Settings -Name 'UseBigButtons' -Value 0
Set-ItemProperty -Path $shellRegPath\ClassicExplorer\Settings -Name 'ShowStatusBar' -Value 0
Set-ItemProperty -Path $shellRegPath\ClassicExplorer\Settings -Name 'AltEnter' -Value 0
Set-ItemProperty -Path $shellRegPath\ClassicExplorer\Settings -Name 'DisableBreadcrumbs' -Value 0
Set-ItemProperty -Path $shellRegPath\ClassicExplorer\Settings -Name 'ToolbarItems' -Value ([byte[]](0x00,0x00))
Set-ItemProperty -Path $shellRegPath\OpenShell -Name 'LastUpdateTime' -Value 0x161cde38
Set-ItemProperty -Path $shellRegPath\OpenShell\Settings -Name 'Nightly' -Value 1
Set-ItemProperty -Path $shellRegPath\StartMenu -Name 'ShowedStyle2' -Value 1
Set-ItemProperty -Path $shellRegPath\StartMenu -Name 'CSettingsDlg' -Value ([byte[]](0xaf,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xe4,0x02,0x00,0x00,0xb4,0x00,0x00,0x00,0xd7,0x0b,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00))
Set-ItemProperty -Path $shellRegPath\StartMenu\Settings -Name 'Version' -Value 0x040400bf
Set-ItemProperty -Path $shellRegPath\StartMenu\Settings -Name 'MouseClickCommand' -Value 'C:\Users\astes\Documents\WinMac\bin\start.exe'
Set-ItemProperty -Path $shellRegPath\StartMenu\Settings -Name 'ShiftClickCommand' -Value 'C:\Users\astes\Documents\WinMac\bin\power.exe'
Set-ItemProperty -Path $shellRegPath\StartMenu\Settings -Name 'WinKeyCommand' -Value 'C:\Users\astes\Documents\WinMac\bin\start.exe'
Set-ItemProperty -Path $shellRegPath\StartMenu\Settings -Name 'ShiftWin' -Value 'Nothing'
Set-ItemProperty -Path $shellRegPath\StartMenu\Settings -Name 'SearchBox' -Value 'Hide'
Set-ItemProperty -Path $shellRegPath\StartMenu\Settings -Name 'SkinW7' -Value 'Immersive'
Set-ItemProperty -Path $shellRegPath\StartMenu\Settings -Name 'SkinVariationW7' -Value ''
Set-ItemProperty -Path $shellRegPath\StartMenu\Settings -Name 'SkinOptionsW7' -Value ([byte[]]())
