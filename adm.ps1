...
Copy-Item ".\temp\scripts.yaml" "C:\Users\$ENV:USERNAME\AppData\Local\Programs\AutoDarkMode\adm-app\scripts.yaml"  -Force
Copy-Item ".\config\adm\color-mode.ps1" "C:\Users\$ENV:USERNAME\AppData\Local\Programs\AutoDarkMode\adm-app\color-mode.ps1" -Force