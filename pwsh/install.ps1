    ...
    # Nexus Dock
        "9" {
            if ($adminTest) {
                ...
                #     Remove-ItemProperty -Path "HKCU:\Software\WinSTEP2000\NeXuS\Docks" -Name "1Path9"
                }
        ...
        "10" {
            if ($sysType -like "*ARM*") {
                ...
                $urls = @(
                    ...
                    "https://raw.githubusercontent.com/ramensoftware/windhawk-mods/refs/heads/main/mods/classic-desktop-icons.wh.cpp"
                )
