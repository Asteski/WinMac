...
Set-ItemProperty -Path $registryPath0 -Name "NeXuSImage27" -Value $dockRunningIndicator -ErrorAction SilentlyContinue
Set-ItemProperty -Path $registryPath0 -Name "DockBack27Image1" -Value $dockRunningIndicator -ErrorAction SilentlyContinue
...
Set-ItemProperty -Path $registryPath1 -Name "DockBack27Image1" -Value $dockRunningIndicator -ErrorAction SilentlyContinue
...
Set-ItemProperty -Path $registryPath3 -Name "(default)" -Value $recycleBinFullIcon-ErrorAction SilentlyContinue
Set-ItemProperty -Path $registryPath3 -Name "empty" -Value $recycleBinEmptyIcon -ErrorAction SilentlyContinue
Set-ItemProperty -Path $registryPath3 -Name "full" -Value $recycleBinFullIcon -ErrorAction SilentlyContinue
Set-ItemProperty -Path $registryPath4 -Name "Icon" -Value $recycleBinEmptyIcon -ErrorAction SilentlyContinue
Set-ItemProperty -Path $registryPath5 -Name "OrbBitmap" -Value $orbBitmap -ErrorAction SilentlyContinue
